...
export default function Footer() {
  return (
    <footer className="bg-green-deep text-white/65 px-5 md:px-10 py-6 md:py-7 flex flex-col md:flex-row md:justify-between md:items-center gap-4 md:gap-0">
      <div>
        <Link href="/" className="block text-white font-extrabold text-sm no-underline">
      ...
      >
        ...
        <span className="text-[12px] font-bold text-white">Ascension 42</span>
      </a>
    </footer>
  )
}
